    ...
    foreach($_POST as $variable => $value) 
{
	...
	. "click here to define the spectated keyword\n"
	. $value
	. "</p>"
	. "</div>"
	. "<script> var msg = new SpeechSynthesisUtterance('$value was spectated'); window.speechSynthesis.speak(msg); </script>"
	. "</body>"
	. "<html>");
}	
...
{	
 ...
 echo "<script> var msg = new SpeechSynthesisUtterance('you spectated the keyword $value'); window.speechSynthesis.speak(msg); </script>";		
fclose($handle);
exit();
?>